        ...
        <div class="card-body p-8">
            ...
            <form action="{{ route('dokter.store') }}" method="POST">
                ...
                <div class="form-control mb-8">
                    ...
                    <input type="password" name="password_confirmation" placeholder="Ulangi password..." class="input input-bordered border-2 rounded-lg p-2 w-full
                                focus:ring-2 focus:ring-primary" required>
                </div> --}}
