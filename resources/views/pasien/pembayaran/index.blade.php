                        ...
                        <tr class="border-t hover:bg-slate-50 transition align-top">
                            ...
                            <td class="px-6 py-4 text-sm">
                                ...
                                @if($item->status_pembayaran === 'belum_bayar')
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-lg bg-red-100 text-red-700 font-semibold">
                                        Belum Bayar
                                    </span>
                                ...
                                @elseif($item->status_pembayaran === 'menunggu_verifikasi')
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-lg bg-yellow-100 text-yellow-700 font-semibold">
                                        Menunggu Verifikasi
                                    </span>
                                ...
                                @elseif($item->status_pembayaran === 'ditolak')
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-lg bg-orange-100 text-orange-700 font-semibold">
                                ...
                                @else
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-lg bg-green-100 text-green-700 font-semibold">
                                        Lunas
                                    </span>
                            ...
                            <td class="px-6 py-4 text-sm text-slate-700">
                                ...
                                {{-- LINK BUKTI (ANTI CACHE) --}}
                                @if($item->bukti_pembayaran)

                                    <a href="{{ asset('storage/' . $item->bukti_pembayaran) }}?v={{ $item->updated_at?->timestamp ?? time() }}"
                                        target="_blank" class="inline-block mb-2 text-blue-600 hover:underline">
                                ...
                                @else
                                    ...
                                    @if($item->status_pembayaran === 'ditolak')
                                        ...
                                        <div
                                            class="mb-3 rounded-lg bg-orange-50 border border-orange-200 px-3 py-2 text-orange-700 text-sm">
                                    ...
                                    <form action="{{ route('pasien.pembayaran.upload', $item->id) }}" method="POST"
                                        enctype="multipart/form-data" class="space-y-2">

                                        @csrf

                                        <input type="file" name="bukti_pembayaran" class="block w-full text-sm" required>
