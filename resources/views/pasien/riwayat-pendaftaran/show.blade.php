                    ...
                    <table class="w-full">
                        <thead class="bg-slate-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase text-slate-500">Nama Obat
                                </th>
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase text-slate-500">Kemasan
                                </th>
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase text-slate-500">Harga
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($riwayat->periksa->detailPeriksas ?? [] as $index => $detail)
                                <tr class="border-t border-slate-100">
                                    ...
                                    <td class="px-4 py-3 font-medium text-slate-800">{{ $detail->obat->nama_obat ?? '-' }}
                                    </td>
