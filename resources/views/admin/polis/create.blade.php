            ...
            <form action="{{ route('admin.polis.store') }}" method="POST">
                ...
                <div class="form-control mb-5">
                    ...
                    <input type="text" name="nama_poli" value="{{ old('nama_poli') }}"
                        class="input input-bordered w-full rounded-lg text-sm" placeholder="Masukkan nama poli..."
                        required>
                </div>
                ...
                <div class="form-control mb-5">
                    ...
                    <textarea name="keterangan" class="textarea textarea-bordered w-full rounded-lg text-sm" rows="4"
                ...
                <div class="form-control mb-6">
                    ...
                    <input type="number" name="tarif" value="{{ old('tarif') }}"
                        class="input input-bordered w-full rounded-lg text-sm" placeholder="Masukkan tarif poli..."
                        required>
                </div>

                <div class="flex gap-3">

                    <button type="submit" class="px-6 py-2.5 bg-[#2d4499] text-white rounded-lg">
                        Simpan
                    </button>
