<aside class="w-full bg-transparent text-slate-300 flex flex-col min-h-screen">
    ...
    <div class="flex-1 overflow-y-auto px-3 py-4">
        ...
        @if(request()->is('pasien*'))
            <p class="text-xs uppercase tracking-widest text-indigo-400 px-3 mb-3 mt-6">Menu Pasien</p>
            <div class="space-y-1">
                ...
                <a href="{{ route('daftar-poli.index') }}"
                    class="{{ $baseLink }} {{ request()->routeIs('daftar-poli.*') ? $active : $inactive }}">
        ...
        @if(request()->is('dokter*'))
            <p class="text-xs uppercase tracking-widest text-indigo-400 px-3 mb-3 mt-6">Menu Dokter</p>
            <div class="space-y-1">
